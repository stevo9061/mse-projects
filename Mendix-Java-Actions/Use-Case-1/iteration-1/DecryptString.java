...
public class DecryptString extends CustomJavaAction<java.lang.String>
{
	...
	// CC: 1 (base value) + 2 (or) -  (2 for 'or' because you usually add another +1 for each additional logical operator (&& or ||).)
