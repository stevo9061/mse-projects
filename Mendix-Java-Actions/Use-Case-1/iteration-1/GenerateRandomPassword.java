...
public class GenerateRandomPassword extends CustomJavaAction<java.lang.String>
{
	 ...
	 */
	// CC: 1 (Base value) + 5 (Decisions: count == 0, count < 0, allowedChars == null, allowedChars.length == 0 and the loop path)
	 ...
	 */
	// CC: 1 (Base value) + 2 (Decisions: minLengthBound == maxLengthBound, minLengthBound > maxLengthBound and sequential execution)
	 ...
	 */
	// CC: 1 (Base value) + 2 (Decision: begin > end plus the loop path)
