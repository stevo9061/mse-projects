...
function logToFile(message) {
    ...
    fs.appendFileSync("usecase3-log.txt", "[".concat(timestamp, "] ").concat(message, "\n"));
}
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, app, workingCopy, model, modulename, usedMicroflowsTaskTracker, microflowsCC, usedNanoflowsTaskTracker, nanoflowCC;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    usedMicroflowsTaskTracker = _a.sent();
                    microflowsCC = calculateComplexityForMicroflows(usedMicroflowsTaskTracker);
                    return [4 /*yield*/, findModuleNanoflows(model, modulename)];
                case 5:
                    usedNanoflowsTaskTracker = _a.sent();
                    return [4 /*yield*/, calculateComplexityForNanoflows(usedNanoflowsTaskTracker)];
                case 6:
                    nanoflowCC = _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    console.log("\nGesamte Cyclomatic Complexity aller Microflows: ".concat(totalComplexity, "\n"));
                    return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    console.log("\nGesamte Cyclomatic Complexity aller Nanoflows: ".concat(totalComplexity, "\n"));
...
function findModuleMicroflows(model, modulename) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function processPage(page) {
            return __awaiter(this, void 0, void 0, function () {
                var loadedPage, widgets, _i, widgets_1, widget, pageMicroflow;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            if (!(widget instanceof mendixmodelsdk_1.pages.ActionButton &&
                                ...
                                widget.action.microflowSettings.microflow)) return [3 /*break*/, 4];
                        ...
                        case 3:
                            _a.sent(); // Rekursiver Aufruf für Microflows auf der Seite
                            _a.label = 4;
                        case 4:
                            _i++;
                            return [3 /*break*/, 2];
...
function findModuleNanoflows(model, modulename) {
    return __awaiter(this, void 0, void 0, function () {
        // 2. Rekursive Funktion zum Verarbeiten von Nanoflows
        function processNanoflow(nf) {
            return __awaiter(this, void 0, void 0, function () {
                var loadedNf, nanoflowObjects, _i, nanoflowObjects_1, obj, calledNanoflow, calledPage;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!nf || processedNanoflows.has(nf.id))
                                return [2 /*return*/]; // Überspringe bereits verarbeitete Nanoflows
                            processedNanoflows.add(nf.id);
                            return [4 /*yield*/, nf.load()];
                        case 1:
                            loadedNf = _a.sent();
                            if (!loadedNf.objectCollection)
                                return [2 /*return*/];
                            nanoflowObjects = loadedNf.objectCollection.objects || [];
                            _i = 0, nanoflowObjects_1 = nanoflowObjects;
                            _a.label = 2;
                        case 2:
                            if (!(_i < nanoflowObjects_1.length)) return [3 /*break*/, 7];
                            obj = nanoflowObjects_1[_i];
                            if (!(obj instanceof mendixmodelsdk_1.microflows.ActionActivity && obj.action.nanoflow)) return [3 /*break*/, 4];
                            calledNanoflow = obj.action.nanoflow;
                            if (!calledNanoflow) return [3 /*break*/, 4];
                            console.log("Nanoflow \"".concat(nf.name, "\" ruft Nanoflow \"").concat(calledNanoflow.name, "\" auf."));
                            resultNanoflows.push(calledNanoflow);
                            return [4 /*yield*/, processNanoflow(calledNanoflow)];
                        case 3:
                            _a.sent(); // Rekursiver Aufruf
                            _a.label = 4;
                        case 4:
                            if (!(obj instanceof mendixmodelsdk_1.microflows.ActionActivity && obj.action instanceof mendixmodelsdk_1.microflows.ShowPageAction)) return [3 /*break*/, 6];
                            calledPage = obj.action.pageSettings.page;
                            if (!calledPage) return [3 /*break*/, 6];
                            console.log("Nanoflow \"".concat(nf.name, "\" ruft Seite \"").concat(calledPage.name, "\" auf."));
                            return [4 /*yield*/, processPage(calledPage)];
                        case 5:
                            _a.sent(); // Prozessiere die aufgerufene Seite
                            _a.label = 6;
                        case 6:
                            _i++;
                            return [3 /*break*/, 2];
        ...
        function processPage(page) {
            return __awaiter(this, void 0, void 0, function () {
                var loadedPage, widgets, _i, widgets_2, widget, widgetNanoflow;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!page || processedPages.has(page.id))
                        ...
                        case 1:
                            ...
                            _a.label = 2;
                        case 2:
                            if (!(_i < widgets_2.length)) return [3 /*break*/, 5];
                            widget = widgets_2[_i];
                            if (!(widget instanceof mendixmodelsdk_1.pages.ActionButton &&
                                widget.action instanceof mendixmodelsdk_1.pages.CallNanoflowClientAction &&
                                widget.action.nanoflow)) return [3 /*break*/, 4];
                            widgetNanoflow = widget.action.nanoflow;
                            console.log("Gefundener Nanoflow \"".concat(widgetNanoflow.name, "\" auf Seite \"").concat(loadedPage.name, "\"."));
                            resultNanoflows.push(widgetNanoflow);
                            return [4 /*yield*/, processNanoflow(widgetNanoflow)];
                        case 3:
                            _a.sent(); // Rekursiver Aufruf für Nanoflows auf der Seite
                            _a.label = 4;
                        case 4:
                            _i++;
                            return [3 /*break*/, 2];
        ...
        var allNanoflows, processedNanoflows, processedPages, resultNanoflows, moduleNanoflows, _i, moduleNanoflows_1, nf, uniqueNanoflows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    allNanoflows = model.allNanoflows();
                    processedNanoflows = new Set();
                    processedPages = new Set();
                    resultNanoflows = [];
                    console.log("Starte Suche nach Nanoflows im Modul: ".concat(modulename));
                    moduleNanoflows = allNanoflows.filter(function (nf) { var _a; return (_a = nf.qualifiedName) === null || _a === void 0 ? void 0 : _a.startsWith(modulename); });
                    console.log("Gefundene Nanoflows im Modul \"".concat(modulename, "\": ").concat(moduleNanoflows.length));
                    _i = 0, moduleNanoflows_1 = moduleNanoflows;
                    _a.label = 1;
                case 1:
                    if (!(_i < moduleNanoflows_1.length)) return [3 /*break*/, 4];
                    nf = moduleNanoflows_1[_i];
                    resultNanoflows.push(nf);
                    return [4 /*yield*/, processNanoflow(nf)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    uniqueNanoflows = Array.from(new Set(resultNanoflows.map(function (nf) { return nf.id; })))
                        .map(function (id) { return resultNanoflows.find(function (nf) { return nf.id === id; }); })
                        .filter(function (nf) { return nf !== undefined; });
                    console.log("Gefundene eindeutige Nanoflows im Modul \"".concat(modulename, "\": ").concat(uniqueNanoflows.length));
                    uniqueNanoflows.forEach(function (nf) { return console.log("Nanoflow: ".concat(nf === null || nf === void 0 ? void 0 : nf.name)); });
                    return [2 /*return*/, uniqueNanoflows];
            }
        });
    });
}
